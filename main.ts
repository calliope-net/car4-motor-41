...
function SpurSensor () {
    return " " + pins.digitalReadPin(DigitalPin.C11) + " " + pins.digitalReadPin(DigitalPin.C9)
}
...
function Konfiguration () {
    ...
    bit.comment("P9 rechts; P11 links Spursensor (0 schwarz, 1 weiß)")
...
lcd16x2rgb.writeText(lcd16x2rgb.lcd16x2_eADDR(lcd16x2rgb.eADDR_LCD.LCD_16x2_x3E), 0, 0, 15, lcd16x2rgb.lcd16x2_text("CaR4 0.1.0"))
